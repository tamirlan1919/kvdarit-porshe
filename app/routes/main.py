...
ALLOWED_DISTRICTS = {
    'Хасавюртовский район': {
        ...
        'localities': [
            ...
            "борагангечув", "генжеаул", "гоксув",  "дзержинское",
            ...
            'Покровский сельсовет', 'сельское поселение Село Аджимажагатюрт', 'сельское поселение Село Бамматюрт', "гребенской мост",
            'Новосельский сельсовет', 'Бюрукутан', 'Костекский сельсовет', 'Казмааульский сельсовет'
        ]
    },
    'Кизлярский район': {
        'keywords': ['кизляр'],
        'localities': [
            ...
            "цветковка", "черняевка", "школьное", "юбилейное", "южное", "ясная поляна", 'кизляр',
             ...
             'Черняевский сельсовет', 'Брянский сельсовет', 'Цветковский сельсовет', 'Новосеребряковский сельсовет', 'Яснополянский сельсовет', 'Большеарешевский сельсовет',
             'Крайновский сельсовет', 'Большезадоевский сельсовет'
    ...
    try:
        if form.validate_on_submit():
            ...
            if not is_district_allowed(district):
                ...
                logging.warning(f"Попытка регистрации из запрещённого района: {district}")
                return render_template('index.html', form=form, is_registered=is_registered, community_link=community_link)
